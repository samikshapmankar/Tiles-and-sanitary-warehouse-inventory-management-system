...
public class Purchases extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        String[] columnNames = {"Purchase No.","Name", "Address", "Contact","Date"};
        ...
        jLabel1.setText("Search by purchase no.:");
        ...
        try {
            pst=con.prepareStatement("select * from purchase order by date desc");
            ...
            while(rs.next())
            {
                ...
                String pno=rs.getString("pnumber");
                String date=rs.getString("date");

                model.addRow(new Object[]{pno,name,addr,cont,date});
...
//            });
            ...
            ResultSet rs=db.searchPurchase(key);
            try {
                while(rs.next()){
                    int idd=rs.getInt("id");
                    String name=rs.getString("name");
