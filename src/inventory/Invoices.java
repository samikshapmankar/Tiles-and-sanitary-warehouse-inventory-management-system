...
public class Invoices extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        String[] columnNames = {"Invoice No.","Customer Name", "Date", "Total Price"};
        ...
        try {
            pst=con.prepareStatement("select * from invoice order by invno asc");
            ...
            while(rs.next())
            {
                ...
                ResultSet rrs=db.getCustomerById(custid);
                rrs.next();
                Double totpr=db.InvoiceProductsTotPrice(idd);
                model.addRow(new Object[]{invno,rrs.getString("name"),date,totpr});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String key=searchkey.getText();
            ...
            ResultSet rs=db.searchInvoices(key);
            try {
                while(rs.next()){
                    int idd=rs.getInt("id");
                    String invno=rs.getString("invno");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int column = 0;
        int id=Integer.parseInt((String) jTable1.getValueAt(row, column));

          this.removeAll();
          this.repaint();
          this.revalidate();
          this.add(new InvoiceDetails(id));
          this.repaint();
          this.revalidate();
